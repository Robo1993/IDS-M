...
(function (root, factory) {
  ...
  // Mirrors this vector on the y-axys
  /**
   * @return {Vector} This for chaining.
   */
  Vector.prototype['mirror'] = Vector.prototype.mirror = function () {
    var x = this['x'];
    var y = this['y'];
    this['x'] = x * -1;
    this['y'] = y;
  ...
  // THIS IS A CUSTOM FUNCTION!!!!!!!!!!!!!!
  // Mirrors the Polygon on the y-axys. 
  /**
  * @return {Polygon} This for chaining.
  **/
  Polygon.prototype['mirror'] = Polygon.prototype.mirror = function() {
    var points = this['points'];
    var len = points.length;
    for (var i = 0; i < len; i++) {
      points[i].mirror();
